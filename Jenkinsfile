            ...
            steps {
                ...
                sh """
                    ssh -o StrictHostKeyChecking=no ubuntu@${EC2_BUILDER} '
                        ...
                        # Pull latest images for cache (speeds up builds)
                        ...
                        cd fastapi-server
                        docker build -t multiframework-fastapi:\${BUILD_TAG} \\
                        ...
                        cd django-server
                        docker build -t multiframework-django:\${BUILD_TAG} \\
                        ...
                        cd node-server
                        docker build -t multiframework-node:\${BUILD_TAG} \\
                        ...
                        echo "Building .NET..."
                        cd dotnet-server
                        docker build -t multiframework-dotnet:\${BUILD_TAG} \\
